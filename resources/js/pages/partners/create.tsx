...
/**
 * Partner Create Page - Add new partner form
 *
 * Design Philosophy:
 ...
 * - PromptPay info tooltip for users unfamiliar with it
 * - Default commission rate pre-filled to 15%
 * - Save and Save & Activate buttons for flexibility
...
export default function PartnerCreate() {
     ...
     */
    const handleSubmit = (e: FormEvent, activate = false) => {
        e.preventDefault();
