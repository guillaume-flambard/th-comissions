...
/**
 * Partner Edit Page - Comprehensive partner editing form
 */
export default function PartnerEdit({
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        city: partner.city || '',
        country: partner.country || 'TH',
        website: partner.website || '',
        promptpay_id: partner.promptpay_id || '',
        default_commission_rate: partner.default_commission_rate || 15,
        commission_structure: partner.commission_structure || 'percentage',
        fixed_commission_amount: partner.fixed_commission_amount?.toString() || '',
        payment_method: partner.payment_method || 'promptpay',
        payment_currency: partner.payment_currency || 'THB',
     ...
     */
    const handleCancel = () => {
        router.visit(`/admin/partners/${partner.id}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit ${partner.business_name}`} />
